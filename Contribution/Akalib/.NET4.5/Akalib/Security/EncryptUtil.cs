...
namespace Akalib.Security
{
	public static class EncryptUtil
	{
		public static string GenerateRandomSeed(string seed = "")
		{
			// 乱数と任意の文字を用いたシード値をMD5でハッシュ化する

			var rnd = new System.Random();
			byte[] data = System.Text.Encoding.UTF8.GetBytes("D96495B2A64D4A458DFE90BD2F804290" + rnd.Next().ToString() + seed);
			...
			// MD5の文字数が多すぎるので、5文字まで無理矢理削る
			//var padding = result.ToString().Substring(0, 5);
