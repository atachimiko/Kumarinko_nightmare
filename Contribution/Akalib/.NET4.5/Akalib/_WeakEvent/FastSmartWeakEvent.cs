...
namespace Akalib
{
	...
	public sealed class FastSmartWeakEvent<T> where T : class
	{
		...
		/// <summary>
		/// PropertyChangedイベント専用のイベント発行を行う処理
		/// </summary>
		/// <typeparam name="TResult"></typeparam>
		/// <param name="propertyName"></param>
		public void Raise<TResult>(Expression<Func<TResult>> propertyName)
		{
			...
			Raise(sender, new PropertyChangedEventArgs(memberEx.Member.Name));
		}
